...
export default function SystemBuilderContent ( props: Props ) {
    ...
    return (
        <div className='flex items-center'>
            ...
            <div className='relative z-10 bg-[url("/assets/content/system-builder/sa-01.png")] bg-center bg-[length:1920px_1080px] bg-fixed bg-no-repeat flex items-center justify-center h-[720px] w-[60%] pb-12'>
