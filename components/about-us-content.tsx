        ...
        <div id='goals' className='bg-white'>
            <div className='mx-96 py-20'>
                ...
                <div className='grid gap-2'>
                    ...
                    <p className='text-gray-950 py-5'>
                        While every business is built to create wealth, we also believe that wealth creation is secondary to our mission, a reward for doing our job diligently and passionately. our topmost priority is to deliver lasting value and benefits for our clients and the people and organizations that work for us. This reflects in our business decisions, work ethics and culture. 
                    </p>
                </div>
