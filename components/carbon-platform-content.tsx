            ...
            ` }>
                ...
                <div className='flex justify-center'>
                    <div className='grid gap-2 w-[720px]'>
                        <h5 className='text-sky-700 text-sm sm:text-base uppercase text-center'>Clean Energy + Sustainability</h5>
                        <h1 className='text-[#111827] text-2xl sm:text-4xl font-bold text-center'>Accelerating Carbon Footprint Reduction through projects that generate Carbon Credits</h1>
                    </div>
                </div>
                ...
                <div className='grid grid-cols-1 xl:grid-cols-2'>
                    ...
                    <div className='flex items-center px-0 lg:px-10 py-5 lg:py-10'>
                        <div className='block'>
                            <h5 className='text-sky-700 text-sm sm:text-base uppercase'>what is carbon accounting?</h5>
                            <div className='my-2'></div>
                            <h1 className='text-[#111827] text-2xl sm:text-4xl font-bold'>Helping to fight climate change</h1>
                            <div className='my-5 sm:my-10'></div>
                            <p className='text-[#111827] text-sm sm:text-base'>
                ...
                <div className='grid grid-cols-1 xl:grid-cols-2'>
                    <div className='flex items-center px-0 lg:px-10 py-5 lg:py-10 order-last xl:order-first'>
                        <div className='block'>
                            <h5 className='text-sky-700 text-sm sm:text-base uppercase'>what is carbon credit?</h5>
                            <div className='my-2'></div>
                            <h1 className='text-[#111827] text-2xl sm:text-4xl font-bold'>Processing resources can generate carbon footprint</h1>
                            <div className='my-5 sm:my-10'></div>
                            <p className='text-[#111827] text-sm sm:text-base'>
                ...
                <div className='grid grid-cols-1 xl:grid-cols-2'>
                    ...
                    <div className='flex items-center px-0 lg:px-10 py-5 lg:py-10'>
                        <div className='block'>
                            <h5 className='text-sky-700 text-sm sm:text-base uppercase'>credits as digital tokens</h5>
                            <div className='my-2'></div>
                            <h1 className='text-[#111827] text-2xl sm:text-4xl font-bold'>We had better idea</h1>
                            <div className='my-5 sm:my-10'></div>
                            <p className='text-[#111827] text-sm sm:text-base'>
                    ...
                    <div className='hidden xl:block absolute top-0 bottom-0 bg-black/50'>
                        <div className='flex items-center h-full px-10'>
                            <div className='grid gap-2'>
                                ...
                                <p className='text-white'>Clean Energy Projects that are funded by purchasing carbon credits will generate new carbon credits to fund more projects in the future. This cycle can provide not just for sustainable life in the community but can also accelerate the adoption of clean and renewable energy.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex xl:hidden items-center px-0 lg:px-10 py-5 lg:py-10'>
                    <div className='block'>
                        <h5 className='text-sky-700 text-sm sm:text-base uppercase'>the loop continues as we develop</h5>
                        <div className='my-2'></div>
                        <h1 className='text-[#111827] text-2xl sm:text-4xl font-bold'>The Cycle of Sustainability</h1>
                        <div className='my-5 sm:my-10'></div>
                        <p className='text-[#111827] text-sm sm:text-base'>
                ...
                <div className='flex justify-center'>
                    <div className='block w-[720px]'>
                        <h5 className='text-sky-700 text-sm sm:text-base text-center uppercase'>join us!</h5>
                        <div className='my-2'></div>
                        <h1 className='text-[#111827] text-2xl sm:text-4xl font-bold text-center pb-5'>Help us develop this technology</h1>
                        <div className='flex justify-center'>
                            <div className='bg-sky-700 h-5 w-5'></div>
                        </div>
                        <p className='text-[#111827] text-sm sm:text-base text-center pt-5'>We at EZPower is determined to make this idea possible, therefore we invite the government, businesses, organizations and professionals to work with us in this project.</p>
                    </div>
                </div>
