        ...
        <section className='bg-white'>
            ...
            ` }>
                ...
                <div className='flex flex-col space-y-2 w-full lg:w-[720px]'>
                    ...
                    <p className='text-[#111827] text-sm sm:text-base py-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio in quod nobis ab molestias molestiae modi expedita, placeat, cum fuga reprehenderit totam, quaerat aliquid aut ex repellendus aliquam! Eveniet, nihil.</p>
                </div>

                <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-10 py-5 sm:py-10'>
                    {
                        source.map( ( arr: { img: string , solution: string , content: string } , ind: number ) => (
                            <div key={ ind } className='relative bg-white w-full shadow-black/20 shadow-2xl rounded-sm transition ease-in-out duration-300 group hover:bg-[#111827]'>
                                ...
                                <div className='p-4'>
                                    <h5 className='text-[#111827] text-base sm:text-lg font-medium capitalize group-hover:text-white'>{ arr.solution }</h5>
                                ...
                                <Link href={ `/energy-solutions/${ arr.solution.replace( /\s/g , '-' ) }` } className='flex items-center bg-[#111827] text-white text-sm font-medium uppercase cursor-pointer rounded-sm px-5 py-3 mx-4 mb-4 w-max transition ease-in-out duration-300 group-hover:bg-white group-hover:text-[#111827] group'>
                                    learn more
