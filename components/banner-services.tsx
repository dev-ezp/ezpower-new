...
export default function BannerServices ( props: Props ) {
    ...
    return (
        <div className='relative z-10 bg-[url("/assets/7.jpg")] bg-center bg-[length:1920px_1080px] bg-fixed bg-no-repeat flex items-center justify-center h-[500px] pb-12'>
