...
export default function ProjectsHome ( props: Props ) {
            ...
            <div className='mx-96 py-20'>
                ...
                <div className='flex items-center justify-between w-full pb-10'>
                    ...
                    <div className='flex flex-col space-y-5 items-center justify-center p-16 h-full w-max'>
                        <Link
                            href='/'
                            className='flex items-center bg-white border-white text-[#111827] border-2 font-medium uppercase cursor-pointer rounded-sm py-4 px-8 transition ease-in-out duration-300 hover:bg-sky-700 hover:border-sky-700 hover:text-white'
                        >
                            see all projects
                            <svg
