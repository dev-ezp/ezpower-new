        ...
        <div className='bg-white'>
            <div className='mx-96 pt-10'>
                ...
                <div className='flex items-center h-full'>
                    ...
                    <Link href='/energy-solutions' className='flex items-center justify-center bg-white border-gray-200 text-[#111827] text-sm font-medium uppercase h-10 px-4 border-y-2 border-l-2 transition ease-in-out duration-300 hover:bg-[#111827] hover:border-[#111827] hover:text-white'>
                        <svg
