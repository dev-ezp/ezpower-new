...
export default function EnergySolutionsBreadcrumbs ( props: Props ) {
        ...
        <section className='bg-white'>
            ...
            ` }>
                ...
                <div className='flex justify-center md:justify-start items-center h-full'>
                    ...
                    <Link href='/energy-solutions' className='flex items-center justify-center bg-white border-gray-200 text-[#111827] text-xs md:text-sm font-medium uppercase h-10 px-4 border-y-2 border-l-2 transition ease-in-out duration-300 hover:bg-[#111827] hover:border-[#111827] hover:text-white'>
                        <svg
